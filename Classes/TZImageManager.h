...
//- (void)getVideoOutputPathWithAsset:(PHAsset *)jhyAsset completion:(void (^)(NSString *outputPath,NSURL *outputURL))completion andProgresCallBlcok:(JHYExportProgressCallBlock)progressBlock andFaildBlock:(void(^)())faildBlock;
...
@property(nonatomic,strong,readonly)MHImagePickerAppearanceConfig *config;

@property(nonatomic,strong,readonly)void (^TZImageManagerConfig)(MHImagePickerAppearanceConfig *config);
