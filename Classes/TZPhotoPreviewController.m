...
- (void)configCustomNaviBar {
    ...
    _backButton = [[UIButton alloc] initWithFrame:CGRectMake(10, 30, 44, 44)];
    
    [_backButton setBackgroundImage:[TZImageManager manager].config.nav_back forState:UIControlStateNormal];
    [_backButton setBackgroundImage:[TZImageManager manager].config.nav_back_h forState:UIControlStateHighlighted];
    ...
    _selectButton = [[UIButton alloc] initWithFrame:CGRectMake(self.view.tz_width - 54, 22, 42, 42)];

    [_selectButton setImage:[TZImageManager manager].config.photo_def_picker_preview forState:UIControlStateNormal];
    
    [_selectButton setImage:[TZImageManager manager].config.photo_sel_picker_preview forState:(UIControlStateSelected)];
...
- (void)configBottomToolBar {
    ...
    if (_tzImagePickerVc.allowPickingOriginalPhoto) {
        ...
        [_originalPhotoButton setImage:[TZImageManager manager].config.photo_def_original forState:UIControlStateNormal];
        [_originalPhotoButton setImage:[TZImageManager manager].config.photo_sel_original forState:UIControlStateSelected];
    ...
    _numberImageView=[[UIImageView alloc]initWithImage:[TZImageManager manager].config.photo_number_bg];
