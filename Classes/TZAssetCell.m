...
- (void)setModel:(TZAssetModel *)model {
    ...
    self.selectImageView.image=self.selectPhotoButton.isSelected ?[TZImageManager manager].config.photo_sel_picker:[TZImageManager manager].config.photo_def_picker;
...
- (void)selectPhotoButtonClick:(UIButton *)sender {
    ...
    self.selectImageView.image=sender.isSelected ?[TZImageManager manager].config.photo_sel_picker:[TZImageManager manager].config.photo_def_picker;
...
- (UIImageView *)viewImgView {
    if (_viewImgView == nil) {
        ...
        [viewImgView setImage:[TZImageManager manager].config.videoIcon];
...
- (UIImageView *)arrowImageView {
    if (_arrowImageView == nil) {
        ...
        [arrowImageView setImage:[TZImageManager manager].config.tableviewArrow];
...
- (UIButton *)selectedCountButton {
    if (_selectedCountButton == nil) {
        ...
        selectedCountButton.backgroundColor = [UIColor clearColor];
